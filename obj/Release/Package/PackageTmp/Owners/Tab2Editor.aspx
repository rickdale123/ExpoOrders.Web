<%@ Page Title="" Language="C#" MasterPageFile="~/Owners/OwnersMaster.Master" AutoEventWireup="true"
    CodeBehind="Tab2Editor.aspx.cs" Inherits="ExpoOrders.Web.Owners.Tab2Editor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <asp:PlaceHolder ID="plcTabEditor" runat="server">
        <fieldset class="commonControls">
            <legend class="commonControls">Tab 2 Editor (Form Submissions) &nbsp;&nbsp;<a id="tab2EditorHelp" href="#" onclick="return false;"><img id="Img5" src="~/Images/help_16x16.gif" alt="Help" style="border-width: 0px;" runat="server" /></a></legend>
    ...
    <telerik:RadToolTip runat="server" ID="tab2EditorTT" Skin="Web20" HideEvent="ManualClose"
        Width="350px" ShowEvent="onmouseover" RelativeTo="Element" Animation="Resize"
        TargetControlID="tab2EditorHelp" IsClientID="true" Position="TopRight"
        Title="tbd">
        <%=ConfigureToolTip(tab2EditorTT, "Tab2EditorHelp")%>
    </telerik:RadToolTip>
</asp:Content>
