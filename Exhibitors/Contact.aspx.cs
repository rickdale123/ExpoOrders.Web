...
{
    public partial class Contact : BaseExhibitorPage
    {
        ...
        {
            this.Master.LoadMasterPage(CurrentUser, CurrentUser.CurrentShow, ExhibitorPageEnum.ContactInfo);



            //Display the Default content that May be defined at the Tab level
            TabLink currentTab = FindCurrentTab(ExhibitorPageEnum.ContactInfo);
            if (currentTab != null)
            {
