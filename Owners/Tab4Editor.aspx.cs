...
{
    public partial class Tab4Editor : BaseTabEditorPage
    {
        ...
        private void LoadSubNavLinks()
        {
            ...
            this.LoadPageMode(pageSubNavLinks, ShowSettingPageMode.Tab4Editor);
        }
        ...
        private void LoadPageMode(int navLinkId, int targetId)
        {
            ...
            {
                navLinkId = 1;
                targetId = (int)ShowSettingPageMode.Tab4Editor;
        ...
        {
            TabLink tab = TabMgr.GetTabByShowAndTabNumber(this.CurrentUser.CurrentShow.ShowId, 4);
            ...
            List<NavigationLink> navLinks = OwnerUtil.BuildAllActiveNavLinks(4, tab, chkIncludeInactive.Checked);
        ...
        {
            WebUtil.LoadNavigationActionChoices(TabMgr, 4, ddlAction);
        }
            ...
            if (actionId > 0)
            {
                ...
                switch (actionId)
                {
                    ...
                    case (int)NavigationLink.NavigationalAction.DynamicForm:
                        ...
                        plcTargetAsset.Visible = true;
                        break;
                    case (int)NavigationLink.NavigationalAction.AdvanceWarehouseLabel:
                    case (int)NavigationLink.NavigationalAction.DirectShowSiteLabel:
                    case (int)NavigationLink.NavigationalAction.OutboundShippingLabel:
