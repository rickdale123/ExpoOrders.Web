...
namespace ExpoOrders.Web.Owners
{
    ...
    public partial class Tab3Editor : BaseTabEditorPage
    {
        ...
        private void LoadSubNavLinks()
        {
            ...
            this.LoadPageMode(pageSubNavLinks, ShowSettingPageMode.Tab3Editor);
        }
        ...
        private void LoadPageMode(int navLinkId, int targetId)
        {
            ...
            {
                navLinkId = 1;
                targetId = (int)ShowSettingPageMode.Tab3Editor;
        ...
        private List<NavigationLink> BuildNavLinks()
        {
            List<NavigationLink> navLinks = new List<NavigationLink>();

            foreach (GridViewRow row in this.grdvwNavigationLinkList.Rows)
            {
                throw new Exception(row.GetType().ToString());
            }
            return navLinks;
        }
        ...
        {
            TabLink tab = TabMgr.GetTabByShowAndTabNumber(this.CurrentUser.CurrentShow.ShowId, 3);
            ...
            List<NavigationLink> navLinks = OwnerUtil.BuildAllActiveNavLinks(3, tab, chkIncludeInactive.Checked);
        ...
        {
            WebUtil.LoadNavigationActionChoices(TabMgr, 3, ddlAction);
        }
