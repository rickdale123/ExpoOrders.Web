<%@ Page Title="" Language="C#" MasterPageFile="~/Owners/OwnersMaster.Master" AutoEventWireup="true" CodeBehind="Tab3Editor.aspx.cs" Inherits="ExpoOrders.Web.Owners.Tab3Editor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <asp:PlaceHolder ID="plcTabEditor" runat="server">
        <fieldset class="commonControls">
            <legend class="commonControls">Tab 3 Editor (Categories &amp; Products) &nbsp;&nbsp;<a id="tab3EditorHelp" href="#" onclick="return false;"><img id="Img5" src="~/Images/help_16x16.gif" alt="Help" style="border-width: 0px;" runat="server" /></a></legend>
            ...
            <table border="0" width="100%" cellpadding="1" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtTabLinkText" Visible="true" Width="200" CssClass="inputText" MaxLength="50" runat="server" />
                    </td>
    ...
    <asp:PlaceHolder ID="plcManageNavigationLink" runat="server">
        <fieldset class="commonControls">
            ...
            <table border="0" width="100%" cellpadding="1" cellspacing="0">
                <tr>
                    <td class="contentLabelRight">Parent Link</td>
                    <td>
    ...
    <telerik:RadToolTip runat="server" ID="tab3EditorTT" Skin="Web20" HideEvent="ManualClose"
        Width="350px" ShowEvent="onmouseover" RelativeTo="Element" Animation="Resize"
        TargetControlID="tab3EditorHelp" IsClientID="true" Position="TopRight"
        Title="tbd">
        <%=ConfigureToolTip(tab3EditorTT, "Tab3EditorHelp")%>
    </telerik:RadToolTip>
</asp:Content>
