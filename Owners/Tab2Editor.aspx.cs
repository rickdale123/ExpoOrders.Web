...
namespace ExpoOrders.Web.Owners
{
    ...
    public partial class Tab2Editor : BaseTabEditorPage
    {
        ...
        private void LoadSubNavLinks()
        {
            ...
            this.LoadPageMode(pageSubNavLinks, ShowSettingPageMode.Tab2Editor);
        }
        ...
        private void LoadPageMode(int navLinkId, int targetId)
        {
            ...
            {
                navLinkId = 1;
                targetId = (int)ShowSettingPageMode.Tab2Editor;
        ...
        {
            TabLink tab = TabMgr.GetTabByShowAndTabNumber(this.CurrentUser.CurrentShow.ShowId, 2);
            ...
            List<NavigationLink> navLinks = OwnerUtil.BuildAllActiveNavLinks(2, tab, chkIncludeInactive.Checked);
        ...
        {
            WebUtil.LoadNavigationActionChoices(TabMgr, 2, ddlAction);
        }
