...
namespace ExpoOrders.Web.Owners
{
    ...
    public partial class Tab5Editor : BaseTabEditorPage
    {
        ...
        private void LoadSubNavLinks()
        {
            ...
            this.LoadPageMode(pageSubNavLinks, ShowSettingPageMode.Tab5Editor);
        }
        ...
        {
            TabLink tab = TabMgr.GetTabByShowAndTabNumber(this.CurrentUser.CurrentShow.ShowId, 5);
            ...
            List<NavigationLink> navLinks = OwnerUtil.BuildAllActiveNavLinks(5, tab, chkIncludeInactive.Checked);
        ...
        {
            WebUtil.LoadNavigationActionChoices(TabMgr, 5, ddlAction);
        }
